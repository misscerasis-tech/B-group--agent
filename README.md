...
- 指令可转换为结构化操作，并真实写入项目策略、项目状态、产品事实、项目提醒、渠道表现、内容日历、素材包、审核任务、首月计划或进入待确认状态；当前支持市场、渠道、客群、内容方向、素材包频率、项目状态、产品事实新增/提取/确认、提醒创建/改期/完成/忽略、指标录入、风险提醒生成、计划项新增/改期/改状态/完成、指定周期素材包创建/归档/恢复草稿、素材包文件推进、模板海报关联、素材包提交审核、审核任务处理/取消/补齐和首月计划生成。
...
- 产品大脑支持从产品说明、粘贴补充资料或已上传的 TXT/MD/CSV/JSON/DOCX/文本型 PDF 产品资料 Asset 生成产品事实、手动新增事实、确认全部事实；已确认事实不会被本地规则静默覆盖。
...
- 素材包中心支持手动创建素材包结构、文件项关联已审核素材、文件项状态推进、提交 Web 审核和本地 ZIP 可交付文件包导出，ZIP 包含基础 PDF、XLSX、DOCX、TXT、关联素材、素材摘要和 manifest；manifest 会记录策略、产品事实、内容计划、已审核素材和可交付性检查摘要。
